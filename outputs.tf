...
output "frontdoor_custom_https_configurations_custom_https_configuration" {
  ...
  value       = { for k, v in azurerm_frontdoor_custom_https_configuration.frontdoor_custom_https_configurations : k => one(v.custom_https_configuration) if v.custom_https_configuration != null && length(v.custom_https_configuration) > 0 }
}
